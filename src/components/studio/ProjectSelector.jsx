...
export default function ProjectSelector({
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center p-6 bg-gradient-to-br from-secondary/20 to-background" style={{ background: "hsl(240 10% 3%)" }}>
      <motion.div
      ...
      >
        ...
        {projects.length > 0 ? (
          <>
            <h2 className="text-xl font-heading font-bold text-foreground mb-6">Your Projects</h2>
