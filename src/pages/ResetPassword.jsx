...
import { resetPasswordErrorMessage } from "@/lib/authErrorMessages";
  ...
  if (!resetToken) {
    return (
      <AuthLayout
        ...
        footer={
          <Link to="/forgot-password" className="ui-hover rounded-lg px-1 py-1 font-medium text-primary hover:bg-primary/10">
            Request a new link
          </Link>
        }
      >
