...
// Deprecated: server-funded arbitrary-recipient SMS invites created a spam and
// provider-credit abuse surface. Invites are now composed in the user's SMS app.
Deno.serve(async (req) => {
  try {
    ...
    return Response.json({
      error: 'Server-sent SMS invites are disabled. Use the share flow instead.',
