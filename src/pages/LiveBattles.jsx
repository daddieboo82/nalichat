...
export default function LiveBattles() {
  ...
  return <div className="h-full overflow-y-auto bg-slate-950 text-white">
    <div className="mx-auto max-w-6xl px-4 py-8 pb-24">
      ...
      <section className="mt-6 grid gap-3 sm:grid-cols-3"><div className="rounded-xl border border-white/10 p-4"><Users className="mb-2 text-fuchsia-300" /><strong>Live audience</strong><p className="text-sm text-slate-400">Watch and react when rooms launch.</p></div><div className="rounded-xl border border-white/10 p-4"><Volume2 className="mb-2 text-fuchsia-300" /><strong>Fair scoring</strong><p className="text-sm text-slate-400">One scorecard per viewer, rating both artists on three musical criteria.</p></div><div className="rounded-xl border border-white/10 p-4"><Trophy className="mb-2 text-fuchsia-300" /><strong>Artist awards</strong><p className="text-sm text-slate-400">Best Rapper and Best Singer will reflect completed battles.</p></div></section>
