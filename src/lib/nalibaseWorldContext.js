export const WORLD_CONTEXTS = Object.freeze({
  ...
  create: { label: 'CREATE', name: 'NaliStudio World', menuDescription: 'NaliStudio creative world', path: '/world/create', plazaGradient: 'from-cyan-500/30 to-accent/15', storefronts: [{label:'Studio',path:'/studio'},{label:'Quick Record',path:'/record'},{label:'Cover Art',path:'/cover-art'},{label:'Playlists',path:'/playlists'}], glow: 'from-cyan-500/25 via-blue-500/5 to-transparent' },
