export const WORLD_CONTEXTS = Object.freeze({
  connect: { label: 'CONNECT', name: 'NaliChat World', menuDescription: 'NaliChat social world', path: '/world/connect', plazaGradient: 'from-primary/35 to-pink-500/15', storefronts: [{label:'Messages',path:'/messages'},{label:'Creator Network',path:'/explore'},{label:'Profile',path:'/profile'},{label:'Projects',path:'/projects-summary'}], glow: 'from-pink-500/25 via-fuchsia-500/5 to-transparent' },
  create: { label: 'CREATE', name: 'NaliStudio World', menuDescription: 'NaliStudio creative world', path: '/world/create', plazaGradient: 'from-cyan-500/30 to-accent/15', storefronts: [{label:'Studio',path:'/studio'},{label:'Quick Record',path:'/record'},{label:'Cover Art',path:'/cover-art'},{label:'Playlists',path:'/playlists'},{label:'NaliBase OS',path:'https://app.base44.com/apps/6a9bcfb7cdf4628117ca8ada',external:true}], glow: 'from-cyan-500/25 via-blue-500/5 to-transparent' },
  discover: { label: 'DISCOVER', name: 'Creator World', menuDescription: 'Creator discovery world', path: '/world/discover', plazaGradient: 'from-violet-500/30 to-fuchsia-500/15', storefronts: [{label:'Explore',path:'/explore'},{label:'Playlists',path:'/playlists'},{label:'Leaderboard',path:'/leaderboard'},{label:'Analytics',path:'/analytics'}], glow: 'from-violet-500/25 via-fuchsia-500/5 to-transparent' },
  share: { label: 'SHARE', name: 'Project World', menuDescription: 'Projects and file exchange', path: '/world/share', plazaGradient: 'from-emerald-500/30 to-teal-500/15', storefronts: [{label:'File Vault',path:'/files'},{label:'Projects',path:'/projects-summary'},{label:'Messages',path:'/messages'},{label:'Studio Import',path:'/studio'}], glow: 'from-emerald-500/25 via-teal-500/5 to-transparent' },
  visualize: { label: 'VISUALIZE', name: 'Visual World', menuDescription: 'Visual creation world', path: '/world/visualize', plazaGradient: 'from-orange-500/30 to-rose-500/15', storefronts: [{label:'Video Lab',path:'/music-video-generator'},{label:'Cover Art',path:'/cover-art'},{label:'Studio',path:'/studio'},{label:'Explore',path:'/explore'}], glow: 'from-orange-500/25 via-rose-500/5 to-transparent' },
  compete: { label: 'COMPETE', name: 'Arena World', menuDescription: 'Challenges and squads', path: '/world/compete', plazaGradient: 'from-yellow-500/30 to-amber-500/15', storefronts: [{label:'Challenges',path:'/challenges'},{label:'Leaderboard',path:'/leaderboard'},{label:'Create Challenge',path:'/create-challenge'},{label:'Squads',path:'/squad'}], glow: 'from-yellow-500/25 via-amber-500/5 to-transparent' },
});
