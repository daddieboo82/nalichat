...
const steps = [
  ...
  },
  {
    ...
    description: "Publish your tracks to Explore, climb the leaderboard, earn achievements, and showcase your portfolio on a creator profile. AI helps you tag every track with the right BPM, genre, and key.",
    gradient: "from-green-500 via-emerald-500 to-teal-500",
    bgGradient: "from-green-500/30 via-emerald-600/20 to-teal-500/30",
    accent: "green",
    features: [
      { icon: TrendingUp, label: "Track Discovery" },
