...
const steps = [
  ...
  },
  {
    ...
    description: "No subscriptions. No credit card. No trials. Just sign up and start creating — unlimited messaging, high-res sharing, and every creative tool you need.",
