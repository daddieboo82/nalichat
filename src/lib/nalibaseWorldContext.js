export const WORLD_CONTEXTS = Object.freeze({
  ...
  visualize: { label: 'VISUALIZE', name: 'Visual World', menuDescription: 'Music video editor, cover art, Studio, Explore', path: '/world/visualize', plazaGradient: 'from-orange-500/30 to-rose-500/15', storefronts: [{label:'Video Lab',path:'/music-video-generator'},{label:'Cover Art',path:'/cover-art'},{label:'Studio',path:'/studio'},{label:'Explore',path:'/explore'}], glow: 'from-orange-500/25 via-rose-500/5 to-transparent' },
