...
export default function MusicStudioLanding() {
  ...
  useEffect(() => {
    ...
    const description = "Built-in music Studio workflows, AI-assisted creator tools, audio sharing, files, and real-time creator messaging. Start free with NaliChat.";
    document.title = "Music Studio for Creators | NaliChat";
    ...
    <main className="min-h-[100dvh] bg-background text-foreground">
      <section className="mx-auto max-w-6xl px-4 pb-14 pt-[max(4rem,env(safe-area-inset-top))] sm:px-6 sm:pb-20">
        <div className="mx-auto max-w-4xl text-center">
          <p className="mb-4 text-sm font-bold uppercase tracking-[0.2em] text-primary">NaliChat music studio</p>
        ...
        <section className="mt-10 rounded-3xl border border-border/70 bg-card/50 p-6 text-center sm:p-8">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">Start with messaging, then move ideas, audio, files, and creator workflows into NaliChat's built-in Studio experience.</p>
        </section>
