export const WORLD_CONTEXTS = Object.freeze({
  ...
  visualize: { label: 'VISUALIZE', name: 'Visual World', menuDescription: 'Cover art and video ideas; Video Lab coming soon', path: '/world/visualize', plazaGradient: 'from-orange-500/30 to-rose-500/15', storefronts: [{label:'Video Lab',path:'/music-video-generator'},{label:'Cover Art',path:'/cover-art'},{label:'Studio',path:'/studio'},{label:'Explore',path:'/explore'}], glow: 'from-orange-500/25 via-rose-500/5 to-transparent' },
  compete: { label: 'COMPETE', name: 'Arena World', menuDescription: 'Challenges, rankings and squads', path: '/world/compete', plazaGradient: 'from-yellow-500/30 to-amber-500/15', storefronts: [{label:'Challenges',path:'/challenges'},{label:'Leaderboard',path:'/leaderboard'},{label:'Create Challenge',path:'/create-challenge'},{label:'Squads',path:'/squad'}], glow: 'from-yellow-500/25 via-amber-500/5 to-transparent' },
});
