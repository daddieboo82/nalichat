...
describe('Messages Network query errors', () => {
  it('surfaces contacts and public-user loading failures', async () => {
    ...
    expect(source).toContain('isError: directoryError');
    expect(source).toContain('const contactsError = directoryError;');
    expect(source).toContain('const usersError = directoryError;');
